...
class ProjectMemberEntity(object):
    ...
    def __init__(self, id=None, project_id=None, entity_name=None, role_name=None, role_id=None, entity_id=None, entity_type=None):  # noqa: E501
    ...
    def entity_id(self):
        ...
        the id of entity, if the member is an user, it is user_id in user table. if the member is an user group, it is the user group's ID in user_group table.  # noqa: E501
