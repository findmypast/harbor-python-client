...
class Project(object):
    ...
    def __init__(self, project_id=None, owner_id=None, name=None, creation_time=None, update_time=None, deleted=None, owner_name=None, togglable=None, current_user_role_id=None, repo_count=None, chart_count=None, metadata=None):  # noqa: E501
